          ...
          <div className="flex flex-col items-center mt-12">
            ...
            <div className="2xl:flex">
              ...
              <div className="2xl:w-[56vw] flex items-center justify-center">
                <p className={`prose text-white text-3xl ${roboto.className}`}>
                  I began my academic journey at{" "}
                  <span className="text-indigo-600">Iowa State University</span>
                  , where I earned a B.A. in Anthropology with a minor in
                  Mandarin in 2003. My passion for understanding diverse
                  cultures and languages shaped my early career path. To further
                  enhance my expertise, I pursued an MBA in Health Organization
                  Management from Texas Tech University, graduating in 2012.
                  More recently, I completed a Software Engineering Bootcamp at
                  Master School in 2024, equipping myself with the technical
                  skills necessary for the ever-evolving tech industry.
                </p>
              </div>
            </div>
            {/* Text Container 2 */}
            <div>
              ...
              >
                ...
                data center operations. My professional journey has been
                diverse, reflecting my adaptability and wide-ranging interests.
                I have taught English at Chinese universities, providing me with
            ...
            <div className="2xl:flex">
              ...
              >
                <p>
                  ...
                  Postgres, Docker, Django, the Django Rest Framework, and
                  Flask. My commitment to continuous learning and improvement is
                  evident through my contributions to open source projects,
                  particularly in the Django community.
                </p>
                <p>
